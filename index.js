    ...
    if (validat == true) {
        ...
        for (let i = 1; i < num_botons; i++) {
            ...
            if (i == num_boto) {
                ...
                boto.style.backgroundColor = "#360e95";
...
let nom, contrasenya;
let scriptURL = "https://script.google.com/macros/s/AKfycbyvzM5X8ZVN1sJDiF4GQiR8ZZbECUN_PtXz4GHhNdzeYE4QNNM6QONvP0rvN4IfcQe8EA/exec"    // s'ha de substituir la cadena de text per la URL del script
